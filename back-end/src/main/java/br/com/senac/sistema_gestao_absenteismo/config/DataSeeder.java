...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        funcionarioRepository.save(Funcionario.builder()
                .nomeCompleto("Juliana Ramos")
                .emailCorporativo("juliana.ferias@gmail.com")
                .cpf("55566677788")
                .telefone("(21) 99999-0005")
                .dataNascimento(LocalDate.of(1993, 5, 20))
                .nacionalidade("Brasileira")
                .matricula("1004")
                .cargo("Analista Financeiro")
                .setor("Financeiro")
                .dataAdmissao(LocalDate.of(2023, 2, 15))
                .tipoVinculo(TipoVinculo.CLT)
                .cargaHorariaSemanal(40)
                .tipoAcesso(TipoUsuario.FUNCIONARIO)
        ...
        funcionarioRepository.save(Funcionario.builder()
                ...
                .emailCorporativo("carlos.afastado@gmail.com")
                .cpf("66677788899")
                .telefone("(21) 99999-0006")
                .dataNascimento(LocalDate.of(1985, 9, 8))
                .nacionalidade("Brasileira")
                .matricula("1005")
                .cargo("Supervisor de Logística")
                .setor("Logística")
                .dataAdmissao(LocalDate.of(2020, 7, 1))
                .tipoVinculo(TipoVinculo.CLT)
                .cargaHorariaSemanal(40)
                .tipoAcesso(TipoUsuario.FUNCIONARIO)
                .status(StatusFuncionario.AFASTADO)
                .senhaHash(senhaHash)
                .build());

        funcionarioRepository.save(Funcionario.builder()
                .nomeCompleto("Beatriz Oliveira")
                .emailCorporativo("beatriz.inativa@gmail.com")
                .cpf("77788899900")
                .telefone("(21) 99999-0007")
                .dataNascimento(LocalDate.of(1991, 12, 3))
                .nacionalidade("Brasileira")
                .matricula("1006")
                .cargo("Assistente Administrativo")
                .setor("Administrativo")
                .dataAdmissao(LocalDate.of(2022, 10, 10))
                .tipoVinculo(TipoVinculo.CLT)
                .cargaHorariaSemanal(40)
                .tipoAcesso(TipoUsuario.FUNCIONARIO)
        ...
        System.out.println(">>   Funcionario (FERIAS):   juliana.ferias@gmail.com");
        System.out.println(">>   Funcionario (AFASTADO):  carlos.afastado@gmail.com");
        System.out.println(">>   Funcionario (INATIVO):   beatriz.inativa@gmail.com");
    }
}