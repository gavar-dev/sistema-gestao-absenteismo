...
public record FuncionarioCreateRequest(
                ...
                @NotBlank(message = "A senha provisória é obrigatória") @Size(min = 8, max = 72, message = "A senha provisória deve ter entre 8 e 72 caracteres") String senhaProvisoria) {
}
