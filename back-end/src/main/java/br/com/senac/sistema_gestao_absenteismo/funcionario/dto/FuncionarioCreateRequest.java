...
public record FuncionarioCreateRequest(
        ...
        @Size(max = 40, message = "O estado civil deve ter no máximo 40 caracteres")
        String estadoCivil,
        ...
        @Size(max = 80, message = "A naturalidade deve ter no máximo 80 caracteres")
        String naturalidade,
        ...
        @Max(value = 60, message = "A carga horária deve ser de no máximo 60 horas")
        Integer cargaHorariaSemanal,

        @Size(max = 150, message = "O gestor deve ter no máximo 150 caracteres")
        String gestorImediato,

        @Size(max = 120, message = "O local de trabalho deve ter no máximo 120 caracteres")
        ...
        @Size(min = 8, max = 72, message = "A senha provisória deve ter entre 8 e 72 caracteres")
